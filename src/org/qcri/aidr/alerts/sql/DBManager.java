...
public static void createalerts3(int alert_id, String alert_type, String alert_time, String alert_severity, String alert_population){
             Connection connection = null;
             PreparedStatement preparedStatement = null;
             try {
                   // Class.forName(JDBC_DRIVER);
                    connection = DriverManager.getConnection(JDBC_URL, USER,PASSWORD);
                    preparedStatement = connection.prepareStatement("INSERT INTO alerts3 VALUES(?,?,?,?,?)");
...
public static void updatetype(int alert_id, String alert_type){
             ...
             try {
                   // Class.forName(JDBC_DRIVER);
                    connection = DriverManager.getConnection(JDBC_URL, USER,PASSWORD);
                    preparedStatement = connection.prepareStatement("UPDATE alerts3 SET alert_type=? WHERE alert_id=?");
       ...
       public static void readalert() {
             ...
             try {
                   // Class.forName(JDBC_DRIVER);
                    ...
                    ResultSet resultSet = statement.executeQuery("SELECT * FROM alerts3");
             ...
             try {
                    //Class.forName(JDBC_DRIVER);
                    connection = DriverManager.getConnection(JDBC_URL, USER,PASSWORD);
                    preparedStatement = connection.prepareStatement("DELETE FROM alerts3 WHERE alert_id=?");
                    preparedStatement.setFloat(1, alert_id);               
                    boolean b=preparedStatement.execute();
                    if(b==true)
...
public static void main(String[] args) throws IOException { 
             ...
             //createalerts3(3, "Kapil","ejdgdi","jdhjdh", "Los Angeles");
             updatetype(1,"pqr");
             updatetype(2,"heyyaa");
             deletealert(2);
             readalert();
...
String sql = "CREATE TABLE alerts3 " + 
...
String insertTableSQL = "INSERT INTO alerts3" 
